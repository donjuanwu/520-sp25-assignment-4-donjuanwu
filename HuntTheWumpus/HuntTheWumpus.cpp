...
namespace
{
    ...
    /*
        ...
        1. match each UserNotification::Notification event
        2. print a relevant message using std::cout
    */
    HuntTheWumpus::UserNotification MakeUserNotifications()
    {
        HuntTheWumpus::UserNotification notifier;
        
        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::HunterEnteredCave, [] {
            std::cout << "You have entered a new cave. \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::NearbyWumpus, [] {
            std::cout << "You smell something terrible nearby... \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::NearbyBat, [] {
            std::cout << "You hear flapping nearby... \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::NearbyPit, [] {
            std::cout << "You feel a breeze nearby... \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::PitFall, [] {
            std::cout << "You fell into a pit! \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::BatGrabbed, [] {
            std::cout << "A bat picked you up and dropped you somewhere else! \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::WumpusBumped, [] {
            std::cout << "You bumped into the Wumpus! \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::WumpusEatsHunter, [] {
            std::cout << "The Wumpus has eaten you. Game over! \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::WumpusShot, [] {
            std::cout << "You shot the Wumpus! You win! \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::ArrowMissed, [] {
            std::cout << "Your arrow missed! \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::OutOfArrows, [] {
            std::cout << "You are out of arrows! Game over! \n";
            });

        notifier.AddCallback(HuntTheWumpus::UserNotification::Notification::IllegalMoves, [] {
            std::cout << "That is an illegal move! \n";
            });
